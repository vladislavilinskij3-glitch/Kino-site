...
// ВАЖНО: Если ваш старый ключ 4c088f10-ab90-49c9-832a-c023294928c4 истек,
// замените его на новый ключ с сайта kinopoiskapiunofficial.tech.
...
async function fetchAPI(url) {
    try {
        ...
        // Важное дополнение! Проверяем, не вернул ли API собственную ошибку в JSON
        if (data.error || data.message) {
            console.error('⚠️ Ошибка от API:', data.message);
            return null; // Считаем, что данные не пришли
        }
